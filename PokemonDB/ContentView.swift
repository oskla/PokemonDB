...
struct ContentView: View {
    ...
    var filteredPokemons: [PokemonModel] {
        ...
        if !customBools.bools.first(where: {$0.name == "fire"})!.state {result = result.filter {$0.type != "fire"}}
...
//                }
    ...
    func setBools(string: String) {
        ...
        case "All":
            ...
            dontShowFairy = false
            dontShowOther = false
            customBools.bools.forEach{$0.setState(bool: true)}
        ...
        case "None":
            ...
            dontShowFairy = true
            dontShowOther = true
            customBools.bools.forEach{$0.setState(bool: false)}
        default:
